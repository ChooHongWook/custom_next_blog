...
export const categories = [
  { id: 'all', name: '전체', count: blogPostsMockData.length },
  {
    id: 'frontend',
    name: '프론트엔드',
    count: blogPostsMockData.filter((post) => post.category === 'frontend').length,
  },
  {
    id: 'backend',
    name: '백엔드',
    count: blogPostsMockData.filter((post) => post.category === 'backend').length,
  },
  {
    id: 'devops',
    name: 'DevOps',
    count: blogPostsMockData.filter((post) => post.category === 'devops').length,
  },
];
